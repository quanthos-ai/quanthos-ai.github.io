export const content = {
  en: {
    labels: {
      ...
      returnshipTitle: "برنامج AI Foundary المكثف",
      returnshipDiscount: "خصم 35٪ لفترة محدودة",
      returnshipPrice: "الإجمالي: 6500 جنيه مصري",
      returnshipPitch: "20 ساعة / 5 جلسات عملية + مشروع", 
  ...
  ar: {
    labels: {
      ...
      returnshipTitle: "AI Foundary Intensive Program",
      returnshipDiscount: "Limited-time Discount 35%",
      returnshipPrice: "Total: 6500 EGP",
      returnshipPitch: "20h / 5 Practical Sessions + Project",
      returnshipAdImageUrl: "",
